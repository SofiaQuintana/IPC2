...
public class ConversionsFrame extends javax.swing.JFrame {
    ...
    // Metodo encargado de limpiar el espacio del texto de entrada.
    public void cleanField() {
        inputField.setText("");
    }
    
    /* Metodo encargado de concatenar el entero que ha sido ingresado, junto con la respectiva conversion
    ** seleccionada, tambien muestra dicho valor. */
